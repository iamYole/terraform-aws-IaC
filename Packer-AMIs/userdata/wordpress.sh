...
sudo openssl req -newkey rsa:2048 -nodes -keyout /etc/pki/tls/private/ca.key -x509 -days 365 -out /etc/pki/tls/certs/ca.crt \
-subj "/C=UK/ST=London/L=London/O=YTech/OU=devops/CN=*.iamyole.uk"
